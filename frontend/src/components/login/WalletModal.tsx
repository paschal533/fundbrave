...
function WalletModal({ width, style } : {width? : any, style? : any}) {
  ...
  const { connectWallet, login, setCloseModal, closeModal } = useContext(AuthContext)
  ...
  <div className={ `${closeModal ? "!hidden" : "block"}`}>
	<DialogContent className={ `${closeModal ? "!hidden" : "block"}`}>
		...
		<DialogDescription>
         ...
         <div className='w-full mt-3 space-y-3 justify-center items-center flex flex-col'>
          ...
          >
            ...
            <Image src='/images/silk.png' alt="silk" width={25} height={10} />
            <p> Silk</p>
