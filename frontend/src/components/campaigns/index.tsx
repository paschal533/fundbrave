                    ...
                    <Tr className="mt-8" key={index}>
                      ...
                      <Td>
                        <Button
                          colorScheme="teal"
                          onClick={() =>
                            openModal(asset.address, "beneficiary")
                          }
                        >
                          Set Beneficiary
                        </Button>
                      ...
                      <VStack pb="2rem">
                        <VStack className={styles.inputContainer}>
                          ...
                          <Input
                            ...
                            className={styles.inputProposal}
                          ></Input>
                        </VStack>
                        <VStack className={styles.inputContainerProposal}>
                          ...
                          <Text className={styles.inputDescriptionProposal}>
                            This text will show up in the “About” section of
                            your proposal.
                          </Text>
                        </VStack>
                      </VStack>
                    ...
                    <ModalBody>
                      <VStack pb="2rem">
                        <VStack className={styles.inputContainer}>
                          ...
                          <Input
                            value={mediaTitle}
                            onChange={(e: any) => setMediaTitle(e.target.value)}
                            className={styles.inputProposal}
                          ></Input>
                        </VStack>
                        <VStack className={styles.inputContainerProposal}>
                        ...
                        <div className="">
                          ...
                          {mediaUrl && (
                            <Image
                              width={100}
                              className="mt-2 rounded-md justify-center items-center w-full"
                              height={100}
                              src={mediaUrl}
                              alt="uploaded"
                            />
